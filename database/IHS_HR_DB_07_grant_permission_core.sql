...
GRANT SELECT, INSERT, UPDATE, DELETE ON HHS_IHS_HR.DUTYLOCATION TO HHS_IHS_HR_RW_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON HHS_IHS_HR.ADMINCODE TO HHS_IHS_HR_RW_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON HHS_IHS_HR.OCCUPATIONALSERIES TO HHS_IHS_HR_RW_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON HHS_IHS_HR.GRADE TO HHS_IHS_HR_RW_ROLE;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON HHS_IHS_HR.COMPLETE_WAIT TO HHS_IHS_HR_RW_ROLE;
