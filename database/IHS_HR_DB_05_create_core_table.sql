...
-------------------------------------------------------
--  DDL for View DUTY LOCATION
--------------------------------------------------------
CREATE OR REPLACE VIEW DUTYLOCATION AS
SELECT GEO_CODE AS LOC_CODE, STATE_OR_COUNTRY_NAME AS LOC_COUNTRY, STATE_ABBRV AS LOC_STATE, CITY_OR_COUNTRY_NAME AS LOC_CITY, COUNTY AS LOC_COUNTY
    FROM HHS_HR.DUTY_STATION;

-------------------------------------------------------
--  DDL for Admin Code View
--------------------------------------------------------
CREATE OR REPLACE VIEW ADMINCODE AS
SELECT ADMIN_CODE, ADMIN_CODE_DESC AS DESCRIPTION
...
(
	...
	DUTY_STATION			VARCHAR2(4000),
	OFFICE_LOCATION			VARCHAR2(100),
	APPOINTMENT_TYPE		VARCHAR2(100),
	TEMPORARY_REASON		VARCHAR2(600),
	HIRING_PLAN				VARCHAR2(200),
	ADDITIONAL_HIRING_PLAN	VARCHAR2(100),
	SELECTING_OFFICIAL		VARCHAR2(200),
	PCN						VARCHAR2(20),
	CAN						VARCHAR2(20),
	SC_COMMENT				VARCHAR2(3300),
	CLS_COMMENT				VARCHAR2(3300),
	HR_COMMENT				VARCHAR2(3300),
	ADVERTISE_GRADE			VARCHAR2(150),
	TARGET_GRADE			VARCHAR2(10),
	WORK_SCHEDULE			VARCHAR2(30),
	WAY_CLOSE				VARCHAR2(30),
	CUT_OFF					VARCHAR2(10),
	ENTICEMENT				VARCHAR2(1000),
	SPF						VARCHAR2(10),
	COMPLETED_JA			VARCHAR2(10),
	SPECIAL_EXP				VARCHAR2(3300),
	ADDITIONAL_REC			VARCHAR2(400),
	OTHER_REC				VARCHAR2(400),
	SME						VARCHAR2(200),
	REQ_LICENSURE			VARCHAR2(10),
	LAW101630				VARCHAR2(10),
	WAIT_9_MONTHS			VARCHAR2(10),
	WAIT_MONTHS				VARCHAR2(10),
	REQ_SHIFT				VARCHAR2(20),
	STANDBY					VARCHAR2(20),
	ONCALL					VARCHAR2(20),
	TRAVEL					VARCHAR2(40),
	OTHER_CONDITION			VARCHAR2(400),
	REQ_CREDENTIAL			VARCHAR2(10),
	REQ_DRUGTEST			VARCHAR2(10),
	ESSENTIAL				VARCHAR2(10),
	REQ_IMMUNIZATION		VARCHAR2(10),
	REQ_PHYSICAL			VARCHAR2(10),
	REQ_FD					VARCHAR2(10),
	REQ_SUP_PROBATION		VARCHAR2(10),
	PPP_IN_CASE_FILE		VARCHAR2(10),
	CLEARANCE				VARCHAR2(200),
	SPECIAL_SALARY_RATE		VARCHAR2(10),
	PAY_TABLE				VARCHAR2(10),
	PRDC_DATE				VARCHAR2(20),
	ESC_DATE				VARCHAR2(20),
	FLSADC_DATE				VARCHAR2(20),
	PDC_DATE				VARCHAR2(20),
	ORG_TITLE				VARCHAR2(100)
);
